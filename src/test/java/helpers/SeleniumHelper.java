...
public class SeleniumHelper {
    ...
    public static String takeScreenshot(WebDriver driver, String filePath) throws IOException {
        ...
        File destinationFile = new File(filePath + "_" + LocalTime.now().getNano() +".png");
        Files.copy(screenshotFile.toPath(), destinationFile.toPath());
        //powinno być return destinationFile.getAbsolutePath(), ale MacOS nie potrafi podać prawidłowej ścieżki
